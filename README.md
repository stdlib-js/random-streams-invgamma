...
```bash
npm install @stdlib/random-streams-invgamma
```
...
```bash
npm install -g @stdlib/random-streams-invgamma
```
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/random-streams-invgamma
